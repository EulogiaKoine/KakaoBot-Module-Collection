...
let send
if(typeof BotManager === 'object' && typeof BotManager.getCurrentBot === 'function'){
    const bot = BotManager.getCurrentBot()
    send = (room, msg) => bot.send(room, msg)
} else {
    send = (room, msg) => Api.replyRoom(room, msg)
}
Object.defineProperty(User.prototype, 'send', {
    value(msg){ send(this.room, msg) }
})
